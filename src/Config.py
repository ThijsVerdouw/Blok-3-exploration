...
class Settings(BaseModel):
    ...
    downloadLink: str = (
        "https://screeps.com/api/leaderboard/list?limit=20&mode=world&offset="
    )
    startYear: int = 2015
    ...
    # Model variables:
    numericTransformerType: str = "median"
    categoricalStrategyType: str = "most_frequent"
    categoricalHandle_unknown: str = "ignore"
